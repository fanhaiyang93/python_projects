#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2018/3/11 22:54
# @Author  : fanhaiyang
# @File    : handler.py
# @Software: PyCharm Community Edition
# @comment : 处理程序，分析器使用处理程序来产生输出。每个处理程序都能产生一种不同类型的标记。
import re
class Handler:
...
class HTMLRenderer(Handler):  # htmlRenderer是handler的子类
    """
    ...
    def test(self):
        self.start('list')
        print(re.sub(r'\*(.+?)\*',self.sub('emphasis'),'This *is* a test!'))
